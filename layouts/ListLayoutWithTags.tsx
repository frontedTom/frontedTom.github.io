          ...
          <div className="card hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto border bg-gray-50 pt-5 dark:bg-gray-900/70 sm:flex">
            <div className="px-6 py-4">
              {pathname.startsWith('/blog') ? (
                <h3 className="font-bold uppercase text-[#f17a7e]">{t('blog_title')}</h3>
              ) : (
                <Link
                  href={`/blog`}
                  className="font-bold uppercase text-gray-700 hover:text-[#f17a7e] dark:text-gray-300 dark:hover:text-[#f17a7e]"
                >
                  {t('blog_title')}
                </Link>
              )}
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        <h3 className="inline px-3 py-2 text-sm font-bold uppercase text-[#f17a7e]">
                          {`${t} (${tagCounts[t]})`}
                        </h3>
                      ) : (
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="px-3 py-2 text-sm font-medium uppercase text-gray-500 hover:text-[#f17a7e] dark:text-gray-300 dark:hover:text-[#f17a7e]"
