...
<div className="grid grid-cols-3 gap-3">
  <b className="font-mono text-4xl"> CodeTom </b>
  <b className="font-zzz text-4xl"> CodeTom </b>
  <b className="font-zzz2 text-4xl"> CodeTom </b>
  <b className="font-starrail text-4xl"> CodeTom </b>
  <b className="font-teyvat text-4xl"> CodeTom </b>
  <b className="font-fontaine text-4xl"> CodeTom </b>
</div>
