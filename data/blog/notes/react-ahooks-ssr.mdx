---
title: React aHooks & SSR
date: '2025-09-08'
tags: ['React aHooks', 'SSR', 'Q&A']
draft: true
summary: Using react hooks in ssr.
---
...
2. 根据环境动态的指定是使用 useEffect 还是 useLayoutEffect。这是来自社区的一种 hack 解决方案，目前在 react-redux、react-use、react-beautiful-dnd 均使用的这种方案。
