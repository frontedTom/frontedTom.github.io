        ...
        <div className="flex items-center justify-between px-3">
          <Link href="/" aria-label={siteMetadata.headerTitle} className="flex items-center">
            <div className="flex items-center justify-between">
              <div className="mr-3 hidden md:block">
                ...
                <span className="text-[18px] font-bold  hover:text-[#f17a7e]  dark:hover:text-[#f17a7e]">
                  CodeTom
                </span>
              </div>
          ...
          <div className="flex items-center space-x-4 leading-5 sm:space-x-6">
            {useHeaderNavLinks(t)
              ...
              text-gray-900 transition duration-300 hover:text-[#f17a7e] dark:text-gray-100
              dark:hover:text-[#f17a7e] sm:block"
                >
                  {link.title}
                </Link>
              ))}
            <ThemeSwitch className="hover:text-[#f17a7e] dark:hover:text-[#f17a7e]" />
            <LocaleSwitch className="hover:text-[#f17a7e] dark:hover:text-[#f17a7e]" />
